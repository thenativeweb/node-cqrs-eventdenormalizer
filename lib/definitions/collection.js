...
var Definition = require('../definitionBase'),
  EventExtender = require('./eventExtender'),
  util = require('util'),
  _ = require('lodash'),
  dotty = require('dotty'),
...
function Collection (meta, modelInitValues) {
  ...
  this.defaultEventExtender = null;
}
...
_.extend(Collection.prototype, {
  ...
  defaultEventExtension: function (fn) {
    ...
    this.defaultEventExtender = new EventExtender({ name: '', version: 0 }, fn);
