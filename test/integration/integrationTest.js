...
describe('integration', function () {
  ...
  describe('format 1', function () {
    ...
    before(function (done) {
      denorm = api({ denormalizerPath: __dirname + '/fixture', commandRejectedEventName: 'rejectedCommand', revisionGuard: { queueTimeout: 200, queueTimeoutMaxLoops: 2 } });
      denorm.defineEvent({
...
//            name: 'hr'
    ...
    describe('handling an event that has a bigger revision than expected', function () {
      ...
      it('it should not fire an eventMissing event', function (done) {
        ...
        var onEventMissingCalled = false;
